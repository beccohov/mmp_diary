...
Но я пока оставлю эту идею, чтобы далее проверить больше гипотез (время работы GPU ограничено :( ). 
 ...
 Также обнаружил странный факт - при попытке обучения другой схожей модели для распознования эмоций на английском языке, но предобученной только (wav2vec2 large-960h) отсутствует сходимость.
 </li>
 </ul>
 <br>
